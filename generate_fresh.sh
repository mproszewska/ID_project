...
echo "concatening..."
cat heartrates.sql sleeps.sql supplies.sql sessions.sql user_session.sql h_w.sql > generated_data.sql
rm heartrates.sql sleeps.sql supplies.sql sessions.sql user_session.sql range.txt h_w.sql
# psql "$1" < ./sql/drop.sql
